...
VALID_NAME = "doc.docx"
INVALID_NAME = "data.txt"
MISSING_NAME = "missing.docx"
MISSING_INVALID_NAME = "missing.txt"
...
class TestValidateFile:
    ...
    def test_missing_takes_priority_over_format(self):
        assert validate_file(Path(MISSING_INVALID_NAME)) is not None


class TestCLI:
    def test_file_not_found(self, runner, mock_get_credentials, mock_upload):
        result = runner.invoke(app, [MISSING_NAME])
    ...
    def test_no_auth_on_unsupported_format(self, runner, tmp_path, create_files, mock_get_credentials, mock_upload):
        ...
        result = runner.invoke(app, [
            str(tmp_path / VALID_NAME),
            str(tmp_path / INVALID_NAME),
        ])
